            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" class="d-flex mb-3">
                        <input type="text" class="form-control ms-auto" style="width:200px;" name="search" placeholder="Search..." value="<?php echo $search; ?>">
                    </form>
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            if ($search) {
                                ...
                                $orders = getOrderHistory(); // Στην περίπτωση που δεν κάνουμε αναζήτηση
                            }
